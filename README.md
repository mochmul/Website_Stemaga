...
<head>
    ...
    <style>
        body {
            ...
            background-color:  #f5f2b8; /* custom warna background halaman */
        }
        .d-inline-block {
            border-radius: 4px;
        }
        .navbar-custom {
            background-color: #98b8a6 /* custom warna navbar */
        }
        ...
        .welcome-title {
            font-family: fantasy;
            color: rgb(255, 188, 44); /* custom warna teks judul selamat datang */
            text-shadow: #222 1px 1px 4px; /* opsional, agar lebih jelas */
        }
        .color {
            background-color: skyblue !important; /* custom warna tombol */
            font-weight: bold;
            text-shadow: #022202 1px 1px 4px; /* opsional, agar lebih jelas */
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            color:  rgb(233, 233, 233);;
            box-shadow: rgb(246, 248, 248) 2px 2px 10px;
        }
        .card-body {
            font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;
            color: rgb(227, 228, 225);
            text-shadow: #00000080 1px 1px 4px; 
            background-color: #98b8a6;
            border: 2px solid#7070a0; /* custom border pada card */
            border-radius: 10px;
